# Portfolio of Aditya Pandiarajan

A modern, brutalist-style AI systems engineer portfolio built with React, TypeScript, and Vite. Features smooth animations, interactive components, and a bold design aesthetic.

## 🌐 Live Demo

**[View Live Portfolio](https://aditya10cr7.github.io/Aditya-Portfolio/)**
...
```bash
git clone https://github.com/Aditya10CR7/Aditya-Portfolio.git
cd Aditya-Portfolio
```
...
Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://github.com/Aditya10CR7/Aditya-Portfolio/issues).
...
- GitHub: [@Aditya10CR7](https://github.com/Aditya10CR7)
- Email: adityapandiarajan7@gmail.com
- LinkedIn: [Aditya Pandiarajan](https://www.linkedin.com/in/aditya-pandiarajan7/)
