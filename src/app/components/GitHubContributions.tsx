  ...
  useEffect(() => {
    const fetchContributions = async () => {
      try {
        ...
        const url = "https://github-contributions-api.jogruber.de/v4/Aditya10CR7?y=last";
        ...
        try {
          ...
          const fallbackUrl = "https://github-contributions-api.jogruber.de/v4/Aditya10CR7";
  ...
  return (
    <section id="github-contributions" className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <motion.a
            href="https://github.com/Aditya10CR7"
            target="_blank"
