      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <motion.button
            ...
            className="nav-link font-bold text-xl group flex items-center gap-3"
          >
            <span
              className="grid h-10 w-10 place-items-center border-[3px] border-[#1A1A1A] bg-[#00B4D8] text-[#FFFFFF] text-sm font-black"
