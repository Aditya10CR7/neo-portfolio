    ...
    <section id="about" className="py-20 px-4 sm:px-6 lg:px-8 scroll-mt-20">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          >
            <motion.div
              className="border-[3px] border-[#1A1A1A] overflow-hidden max-w-sm mx-auto lg:mx-0 aspect-[3/4] bg-[#F5F0E8]"
          ...
          <div className="relative">
            ...
            >
              ...
              {portfolioData.about.paragraphs.map((paragraph) => (
                <p key={paragraph} style={{ fontFamily: 'var(--font-display)' }} className="text-lg leading-relaxed">
                  {paragraph}
                </p>
              ))}
            </motion.div>
