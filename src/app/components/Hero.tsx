        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
          ...
          >
            <div className="tag-chip-container relative h-[400px] lg:h-[500px]">
              {[
                { text: "#AIEngineer", top: "8%",  left: "55%", delay: 0 },
                { text: "#LLMInfra",       top: "25%", left: "10%", delay: 0.15 },
                { text: "#LangGraph",   top: "45%", left: "60%", delay: 0.3 },
                { text: "#RAG",  top: "65%", left: "15%", delay: 0.45 },
                { text: "#AppliedAI",         top: "80%", left: "50%", delay: 0.6 }
              ].map((tag, index) => (
                <motion.div
                  key={index}
